...
```
cd existing_repo
git remote add origin https://gitlab.pfrus.com/vitaly.gusev/nlp_recurrentnn.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.pfrus.com/vitaly.gusev/nlp_recurrentnn/-/settings/integrations)
